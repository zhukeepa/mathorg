...
ActiveRecord::Schema.define(version: 20150729030745) do
  ...
  create_table "explanation_authors", force: :cascade do |t|
    t.float    "weight"
    t.integer  "user_id"
  ...
  create_table "problem_sets_problems", id: false, force: :cascade do |t|
  ...
  add_index "problems", ["problem_set_id"], name: "index_problems_on_problem_set_id", using: :btree

  create_table "rich_texts", force: :cascade do |t|
    t.text     "text"
    t.integer  "bodyable_id"
    t.string   "bodyable_type", limit: 255
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "topic_topicables", force: :cascade do |t|
    ...
    t.string   "topicable_type", limit: 255
    t.integer  "topic_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
